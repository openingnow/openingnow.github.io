...
const cstr_to_jsstr = ptr => {
    const encoded_result = new Uint8Array(exports.memory.buffer, ptr + strlen_bytes, new Uint32Array(exports.memory.buffer, ptr, strlen_bytes * 8 / 32)[0]);
...
const with_haskell_function = (f, str) => {
    ...
    const arg_heap_addr = exports.malloc(encoded_arg.length + strlen_bytes);
    new Uint32Array(exports.memory.buffer, arg_heap_addr).set([encoded_arg.length]);
    new Uint8Array(exports.memory.buffer, arg_heap_addr + strlen_bytes).set(encoded_arg);
...
const wasm = await WebAssembly.instantiateStreaming(fetch("/assets/1cb6b12d8e770cd45301caf0fff18d6f/c37ae98fe5856ddd778572149619546c.wasm"), importObject);

wasi.initialize(wasm.instance);
const exports = wasm.instance.exports;
exports.hs_init(0, 0);
const strlen_bytes = exports.strlen_bytes();
exports.main();
