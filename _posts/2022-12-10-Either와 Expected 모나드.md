...
자세한 문법은 [cppreference](https://en.cppreference.com/w/cpp/utility/expected)에서 볼 수 있는데 아직 작성이 안 되었으니 optional의 문서를 보면 된다.
...
divBy d = \a -> if d == 0 || mod a d /= 0 then Left $ "Can't div " ++ show a ++ " by " ++ show d else Right $ div a d
