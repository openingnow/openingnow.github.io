...
추석 연휴 때문에 너무 오래 기다렸다. 바로 학원 갔으면 빨리 땄을 텐데.

광연 자동차면허학원. 기종은 VJF250인데 상태는 딱 굴러가기만 하는 정도이다.

아이들링으로 10km/h가 나오니 클러치만 조작하면 된다.

시험에 붙고 나서 서류를 기다리는 동안 옆에 서울공항에 가서 에어쇼를 봤다.
